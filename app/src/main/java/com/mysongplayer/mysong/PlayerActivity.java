...
public class PlayerActivity extends AppCompatActivity {
    ...
    Button btnplay,btnNext,btnPrevious,btnFastForword,btnFastRewind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("My Song Player");
        ...
        mySongs=(ArrayList)bundle.getSerializable("AllSongs");
        position=bundle.getInt("pos",0);
        String sName=mySongs.get(position).toString();
...
//                updateSeekBar.start();
        ...
        btnFastForword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mediaPlayer.isPlaying())
                {
